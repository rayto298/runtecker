      ...
      <section className="flex flex-col justify-center items-end m-7 mr-20">
        <form className="flex gap-2" onSubmit={handleOnSubmit}>
          <input
            ...
            placeholder="Rails React"
            className="input rounded  border-orange-300 focus:outline-orange-500"
            id="search_word"
            value={searchWord}
          />
          {/* TODO : ここをどう実装するか。そもそも必要かは検討したほうがよさげ */}
          <select
            className="select select-bordered rounded border-orange-200 focus:outline-orange-500"
            id="search_term"
            value={searchTerm}
